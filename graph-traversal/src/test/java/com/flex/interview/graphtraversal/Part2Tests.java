...
import com.flex.interview.graphtraversal.tasks.Part2;
...
public class Part2Tests {
	...
	@Test
	void totalCost() {
		double cost = part2.totalCost(GraphCases.case1());
	...
	void totalCostWithChinaTariffs() {
		...
		double totalCosts = part2.totalCostWithTariffs(GraphCases.case1(), tariffProvider);
	...
	void totalCostWithMexicoTariffsWithCablesExempt() {
		TariffProvider tariffProvider = (origin, destination) -> origin.equals("MEXICO") ? 1.0 : 0;
		double totalCosts = part2.totalCostWithExemptTariffs(GraphCases.case1(), tariffProvider,
				List.of("Cables"));
	...
	void totalCostWithChinaTariffsWithPcbaExemptCase2() {
		...
		double totalCosts = part2.totalCostWithExemptTariffs(GraphCases.case2(), tariffProvider,
				List.of("PCBA"));
